...
7. **Formatting**:
 ...
 Ensure the content is **detailed**, **professional**, and focused specifically on the "$detailed_information", providing comprehensive regulatory and process-oriented information and also note that all information should be from relevant dcoument or offical websites or articles no hypothetical answers and all links should be openable no error links and not only give offical website link give link where the information of $detailed_information is there on offical website.
""")
